Shader "Universal Render Pipeline/LitGI"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment LitPassFragmentGI
            ...
            )
            {
                ...
                float3 light_gi = applyGIAt(input.positionWS, input.normalWS);
                inputData.bakedGI += light_gi;
